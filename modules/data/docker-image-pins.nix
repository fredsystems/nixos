{ lib, ... }:
{
  ...
  options.shared.dockerImages = lib.mkOption {
    ...
    default = {
      ...
      tar1090 = "ghcr.io/sdr-enthusiasts/docker-tar1090:telegraf-build-1482@sha256:a1756df1b0692ccbc8a04c74dd034e3fbb9cd83822199602ea3fa183b7ffb706";
      ...
      adsbUltrafeeder = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:telegraf-build-964@sha256:023a53289b5b04fe08887fb536bbbdb88cddca5fa6b359aaaabab46609557218";
