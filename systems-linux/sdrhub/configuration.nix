...
}:
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:latest-build-899@sha256:5cb518af9ba621568a8f04f7fa23344c2e9ee1d5e3191250a621a3370e996272";
      ...
      {
        name = "acarshubv4";
        image = "ghcr.io/sdr-enthusiasts/docker-acarshub:v4-latest-build-62@sha256:627a25197661a63e1d78963d744b44403fe53d35a5605928bb254520f1f9e2a6";
