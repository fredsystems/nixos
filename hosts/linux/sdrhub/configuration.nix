...
}:
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:latest-build-921@sha256:864b4223491b13ccae3fe74a14d7c653f7976d92024b2176808c90a3cf7a24de";
      ...
      {
        name = "fr24";
        image = "ghcr.io/sdr-enthusiasts/docker-flightradar24:latest-build-847@sha256:47c376bb02ff42e292c191fff5c76163aab1767cf7514781475dbd4dfca8dd61";
      ...
      {
        name = "piaware";
        image = "ghcr.io/sdr-enthusiasts/docker-piaware:latest-build-654@sha256:e2f27e4dbe3a84864985bde28a7db9f2bdba5037d889be703c270b0ca71da6d6";
      ...
      {
        name = "radarvirtuel";
        image = "ghcr.io/sdr-enthusiasts/docker-radarvirtuel:latest-build-787@sha256:177389583ad6166608a1e3f9ced3e8c9a2f54a86c23264f7002fc2cbb66f62fa";
      ...
      {
        name = "rbfeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-airnavradar:latest-build-872@sha256:d11818119944eb4674b1acbfd96a3646657ff9e0ac22bdf26d347ccfb50dff14";
      ...
      {
        name = "sdrmap";
        image = "ghcr.io/sdr-enthusiasts/docker-sdrmap:latest-build-89@sha256:1643b5a7025cb85914585971a0f7bf9a0d28f2789e69f9c40938cedfe127a5f0";
      ...
      {
        name = "acarshub";
        image = "ghcr.io/sdr-enthusiasts/docker-acarshub:latest-build-1495@sha256:5c8faec407665a29fd353d54519f5bd7c4e811c7ec7e492f6c56195cc61bbdb1";
