...
in
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "dozzle";
        image = "amir20/dozzle:v10.6.9@sha256:6f4644814cce31e11fe80f2610515df6a5a2e40120b4087c298a72df8d65866b";
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:telegraf-build-945@sha256:a5972b7e3e1aa997eefeecefd30e8404ea9c885fa2f45fe05cd304a0c09c3d04";
      ...
      {
        name = "fr24";
        image = "ghcr.io/sdr-enthusiasts/docker-flightradar24:latest-build-857@sha256:f0e716f7d2c83bceb10cbb6cfe05bc35cb06680b48eedac5844684180686b817";
