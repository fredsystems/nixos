...
in
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "dozzle";
        image = "amir20/dozzle:v10.6.6@sha256:2e14180fa14c195b8e86705b7ab2234b87599215bcf06f7f56396cb45f57f963";
      ...
      # {
      #   name = "airspy_adsb";
      #   image = "ghcr.io/sdr-enthusiasts/airspy_adsb:latest-build-310@sha256:dc4d1298893c4e4a065392ab49331381f77ef6c6c924f39e6a71769a2c572eb9";
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:telegraf-build-933@sha256:f0bd1c3a20cf605c6a691271603b7890fbd262fe92710a98c1ff76a854825a41";
      ...
      {
        name = "dump978";
        image = "ghcr.io/sdr-enthusiasts/docker-dump978:telegraf-build-797@sha256:5faa0af8058407a7d898de642e13ef907915384763c97be71267e8379846a0d6";
      ...
      {
        name = "adsbhub";
        image = "ghcr.io/sdr-enthusiasts/docker-adsbhub:latest-build-525@sha256:3b4ff1165b8755e3477f6f8534d0cc11e226e5555df217218d20480fcffcd60d";
      ...
      {
        name = "fr24";
        image = "ghcr.io/sdr-enthusiasts/docker-flightradar24:latest-build-852@sha256:ea29527713cfd2c0b2875aaed245e315522778f3f314484e483765fc3a9cc493";
      ...
      {
        name = "piaware";
        image = "ghcr.io/sdr-enthusiasts/docker-piaware:latest-build-661@sha256:c8121c209df76e63151b2e428f64f41f48e61c101afa7b146184b72b361e8897";
      ...
      {
        name = "planefinder";
        image = "ghcr.io/sdr-enthusiasts/docker-planefinder:latest-build-536@sha256:5f0ed13e22c27f6868ff7b25d3d7eb64ad7fe4b9f487623c754b6f62c00dca62";
      ...
      {
        name = "radarvirtuel";
        image = "ghcr.io/sdr-enthusiasts/docker-radarvirtuel:latest-build-795@sha256:e574c8f05d01c23c8a0f9dc8509f5b3fb4b53ee1e130d8a6c8edb9ae9a16e7d0";
      ...
      {
        name = "rbfeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-airnavradar:latest-build-877@sha256:bcd5bbb7cee6d52ed1a4bb7d15102daaadcddba1d4f5ea851ac7607d555cf0c3";
      ...
      {
        name = "opensky";
        image = "ghcr.io/sdr-enthusiasts/docker-opensky-network:latest-build-831@sha256:29694a86e56e9946c69bc413aab3b13a3ea41e0d83b56a7c25143c572f1be59a";
      ...
      {
        name = "acarshub";
        image = "ghcr.io/sdr-enthusiasts/docker-acarshub:latest-build-1501@sha256:3d3f71db35beb3ca006ef3053578c28a5c6a1fb80d8d2a591fbccc6002986e46";
