...
}:
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:latest-build-928@sha256:e4eca39fcdadf6984977333af7d1094daedec058a8fe0e741839dc0a13355e5a";
      ...
      {
        name = "degoog";
        image = "ghcr.io/fccview/degoog:0.18.0@sha256:9a59552c04bcbbd2939ea84c69240ac4708e57e7eca17271103b14c3aeb3b858";
