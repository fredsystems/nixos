...
in
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "dozzle";
        image = "amir20/dozzle:v10.7.3@sha256:c32ca7a443796de62a07afd621b17b6c6c073320cd8431493bb1fd84e3a1eff8";
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:telegraf-build-954@sha256:c1dac406e4172d0c0e91bb3a50c49e0c2e364f74ce73c22617ea75fedc1dd403";
