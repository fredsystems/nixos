...
}:
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:telegraf-build-906@sha256:93e1bf3a9519efd6c67740b75706c28e634d6ee8a9cb00fb9402c766bae28094";
      ...
      {
        name = "acarshub";
        image = "ghcr.io/sdr-enthusiasts/docker-acarshub:latest-build-1490@sha256:ebedfdf16c008a99c627d15e3898300f0b2a3efb6f1722ff0ff48e00a4ce308a";
