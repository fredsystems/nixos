...
}:
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:telegraf-build-908@sha256:012bcd204198e2b6ed74adfcb7ab6906ab518aa46ad96af7e591427a9c4160a9";
      ...
      {
        name = "adsbhub";
        image = "ghcr.io/sdr-enthusiasts/docker-adsbhub:latest-build-517@sha256:2e55aa9bc452f61b914959b67f15cfd1d1b8386902086758e473db354fbd3a8f";
      ...
      {
        name = "fr24";
        image = "ghcr.io/sdr-enthusiasts/docker-flightradar24:latest-build-843@sha256:80e8662be431f9e960094cedeca6841bc02a78346b30d5533b2d38546eecc16c";
      ...
      {
        name = "piaware";
        image = "ghcr.io/sdr-enthusiasts/docker-piaware:latest-build-652@sha256:86b490c9b77faada39396988787e5f7c5ffe8b20ea61b6fa3d38a11934e85df1";
      ...
      {
        name = "planefinder";
        image = "ghcr.io/sdr-enthusiasts/docker-planefinder:latest-build-528@sha256:ff1030f189c75e70dca1a4b64cdd7b30083098246b26aa1165716dd00ab96f8b";
      ...
      {
        name = "radarvirtuel";
        image = "ghcr.io/sdr-enthusiasts/docker-radarvirtuel:latest-build-782@sha256:df56e9fdd64f64ad6ff0ed4263aa99ece289d8fa9b146594ba4cfa05e6324516";
      ...
      {
        name = "rbfeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-airnavradar:latest-build-867@sha256:f26c464067e0dce060f7f2387b9d1b6fc0c06c66167e2c4680c2f4b13f24df95";
      ...
      {
        name = "opensky";
        image = "ghcr.io/sdr-enthusiasts/docker-opensky-network:latest-build-823@sha256:c5ddf3ddf70986a532b38b0b68faf49ff90bdb965335863df255e72d82ae1805";
      ...
      {
        name = "sdrmap";
        image = "ghcr.io/sdr-enthusiasts/docker-sdrmap:latest-build-84@sha256:eb61c2a49130e972107ffa911a21da5571aec7634cbe0371020f9bffe201fda6";
      ...
      {
        name = "acarshub";
        image = "ghcr.io/sdr-enthusiasts/docker-acarshub:latest-build-1491@sha256:aab8768b6373f0607225d444c42ea5c133472fae513949937297606bbc03ed07";
      ...
      {
        name = "degoog";
        image = "ghcr.io/fccview/degoog:0.12.0@sha256:d15c1d8445bfd16c89a19c5d9aadc06f700a4a833f8205e17476056e1956c648";
