...
}:
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:latest-build-912@sha256:f980c799c12396b60a61ca0a909561a21b48c8a42066a772b8708ad6694eac42";
      ...
      {
        name = "dump978";
        image = "ghcr.io/sdr-enthusiasts/docker-dump978:telegraf-build-791@sha256:dcddd3720b05fb96daa8b79eb0cd210f04f000790bafc1fcd0794319bb709a39";
      ...
      {
        name = "degoog";
        image = "ghcr.io/fccview/degoog:0.13.0@sha256:489ad2cdee5f02aa0392056b0e759ef8993b185352511acad5e826517afac541";
