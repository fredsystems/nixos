...
}:
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      # {
      #   name = "airspy_adsb";
      #   image = "ghcr.io/sdr-enthusiasts/airspy_adsb:latest-build-300@sha256:71fa8ee9a951c4f4f17cfd9a5af3ca248b114518be5820515358e6f61cb0e4e4";
      ...
      {
        name = "dump978";
        image = "ghcr.io/sdr-enthusiasts/docker-dump978:telegraf-build-785@sha256:cf2064935ecf8f4a89e3ea4e499515c6d418cc5d55e84757e67de90a31cf3e47";
      ...
      {
        name = "acarshub";
        image = "ghcr.io/sdr-enthusiasts/docker-acarshub:latest-build-1488@sha256:6c8b794cf1c6cbedc7e13a6e1044062a9ace3756b8aebb9aa8de97f478c992de";
      ...
      {
        name = "acarshubv4";
        image = "ghcr.io/sdr-enthusiasts/docker-acarshub:v4-latest-build-67@sha256:4420c95cb548ca7a02214b726f0b476a949f43e83f88e3b58b0ff652c7e65595";
