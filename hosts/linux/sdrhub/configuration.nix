...
}:
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:telegraf-build-907@sha256:0e1101ce70fd1e47af3853d596dc0b8126e0d77444a024106ae36586bd56617e";
      ...
      {
        name = "degoog";
        image = "ghcr.io/fccview/degoog:0.10.0@sha256:6066f000a205786a16c6b1b4e2c6d9fe4ec4a60c4343db2650d9c173c125e39e";
