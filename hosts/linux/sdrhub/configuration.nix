...
}:
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:telegraf-build-925@sha256:d031f4df7c496c8ff316054183d3ab7f80b29c4c046fece1ac6f1d2b2cc964c5";
      ...
      {
        name = "fr24";
        image = "ghcr.io/sdr-enthusiasts/docker-flightradar24:latest-build-849@sha256:a809cc66eed21c331e8da9c919f0ae165db8512aba711e8c76a75ec1b7cfc040";
      ...
      {
        name = "sdrmap";
        image = "ghcr.io/sdr-enthusiasts/docker-sdrmap:latest-build-92@sha256:cfc141dbef80e30fd0ea86639d5daca1281966576c995c88d8cd1bb09ea3fbdd";
      ...
      {
        name = "degoog";
        image = "ghcr.io/fccview/degoog:0.17.0@sha256:3cabee5c06ac9774fa5d993cc3a146c59777ec6f5e12e91dd2288ea9160a8265";
