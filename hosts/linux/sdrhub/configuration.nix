...
}:
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "dozzle";
        image = "amir20/dozzle:v10.6.3@sha256:3d42f4c7b27f475117004f8524b52b6ea2cc1cdc39a508892d6b81ffb2883160";
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:telegraf-build-931@sha256:1f7044032e3e2521e13d8d4e1e2c5a1386cd7d9eaab95b527a40c475969ef15d";
      ...
      {
        name = "degoog";
        image = "ghcr.io/fccview/degoog:0.19.1@sha256:7349ab996fbf8632bfcf4253f64d5e1e15a99c93a57619450768fcdf6be1ee57";
