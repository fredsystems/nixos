...
in
{
  ...
  services = {
    ...
    adsb.containers = [
      ...
      {
        name = "dozzle";
        image = "amir20/dozzle:v10.6.11@sha256:bc1ee4ba8d66c7fc0d03823a78486165fb219809f79eaf54cecf3114d647ab14";
      ...
      {
        name = "ultrafeeder";
        image = "ghcr.io/sdr-enthusiasts/docker-adsb-ultrafeeder:latest-build-947@sha256:5785bb8f769937786c9061e5793e36890d5586e3845572e5939976ee599aa8a0";
